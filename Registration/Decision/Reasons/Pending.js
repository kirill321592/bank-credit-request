...
export default ({ submitDecision, submitting, userInfo: { name }}) => {
    return (
        <Row>
            <Col xs={12}>
                <h1>
                    <img src="./img/ico-title-check.svg" alt="PENDING" />
                    {name}<br />
            ...
            <Col xs={12}>
                ...
                <p>
                    <strong>Nuestros especialistas te contactarán al teléfono facilitado
                    durante el registro para su verificación.
                    </strong>
                </p>
